...
const CollaborationTypeSection = ({
  ...
  return <Card>
      <CardContent className="p-4">
        <h3 className="font-semibold text-gray-900 mb-4">Tipo de Colaboración</h3>
        
        <div className="space-y-3">
          {/* Public Option */}
          <div onClick={() => onCollaborationTypeChange('public')} className={`p-4 rounded-lg border-2 cursor-pointer transition-all ${collaborationType === 'public' ? 'border-green-500 bg-green-50' : 'border-gray-200 bg-white hover:border-gray-300'}`}>
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-gray-500 mt-1">Define las condiciones y recibe solicitudes de foodies</div>
              </div>
          ...
          {/* Private Option */}
          <div onClick={() => onCollaborationTypeChange('private')} className={`p-4 rounded-lg border-2 cursor-pointer transition-all ${collaborationType === 'private' ? 'border-blue-500 bg-blue-50' : 'border-gray-200 bg-white hover:border-gray-300'}`}>
            <div className="flex items-center space-x-3">
