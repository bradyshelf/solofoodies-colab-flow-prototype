            ...
            <Card className="border-gray-200">
              <CardContent className="p-4">
                <div className="flex items-start justify-between">
                  ...
                  <Button onClick={() => handleElegirClick('public')} className="px-4 py-2 text-sm rounded-full bg-gray-900 text-white hover:bg-gray-800">
                    Elegir
                  </Button>
                </div>
              </CardContent>
            ...
            <Card className="border-gray-200">
              <CardContent className="p-4">
                <div className="flex items-start justify-between">
                  ...
                  <Button onClick={() => handleElegirClick('private')} className="px-4 py-2 text-sm rounded-full bg-gray-900 text-white hover:bg-gray-800">
                    Elegir
                  </Button>
                </div>
              </CardContent>
